...
- ⚠️ The ticker applies a fixed-step accumulator but lacks the `MAX_FRAME_SKIP` guard and interpolated render pass shown in the spec (`src/js/game-application.ts:325`).
